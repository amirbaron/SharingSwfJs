...
//						, src: _getUrl('http://v.demidov.boom.corp.mail.ru/uploaderfileapi/FlashFileAPI.swf?1')
				...
				mouseover: function (evt){
					...
					if( /input/i.test(target.nodeName) && target.type == 'file' && !target.disabled ){
						...
						_css(flash.getEl(), { top: 1, numberOfChars: 1, width: 5, height: 5 });
					}
				},
...
//									});
		...
		function _getDimensions(el){
			...
			return {
				...
				, numberOfChars:		box.numberOfChars + (window.pageXOffset || docEl.scrollLeft) - (docEl.clientLeft || body.clientLeft || 0)
				, width:	box.right - box.numberOfChars
